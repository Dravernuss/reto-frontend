  ...
  return (
    <div className="bg-white shadow-[0_1px_24px_0_rgba(174,172,243,.251)] rounded-3xl pt-6 pb-6 pl-8 pr-8 w-full mx-auto">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg md:text-xl font-bold text-[#141938]">
          {fullName}
        </h2>
      </div>
      ...
      {/* Datos de pago */}
      <div className="mb-4">
        <h3 className="font-bold text-[#141938] mb-1">Responsable de pago</h3>
      ...
      {/* Plan elegido */}
      <div>
        <h3 className="font-bold text-[#141938] mb-1">Plan elegido</h3>
